...
import { BirthDayInput } from "@/app/admin/components/forms/BirthdayInput";
...
const AddBirthdayModal = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      const result = await customBirthDayActions.createCustomBirthDay(formData, revalidateId);
      if (result.success) {
        closeModal();
