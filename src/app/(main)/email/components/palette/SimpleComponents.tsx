...
const DraggableItem: React.FC<{
  ...
  return (
    <div
      ref={divRef}
      className={`flex flex-col items-center justify-center bg-white rounded-lg shadow-md border-2 hover:bg-slate-50 transition-colors aspect-square cursor-grab ${
    ...
    >
      ...
      <span>
        <MdDragIndicator className="rotate-90 w-4 h-4 text-gray-500 opacity-70" />
      </span>
    </div>
  );
};

const SimpleComponents: React.FC<SimpleComponentsProps> = ({
  onAddComponent,
}) => {
